...
def regions_for_positions(
    ...
    *,
    ...
    Args:
        ...
        pitch_deg, yaw_deg: insertion pose (see :mod:`pixelmap.anatomy.transform`).
        atlas_name: brainglobe atlas identifier.

    Returns:
        Length-``N`` list; entries are ``None`` for positions outside the volume.
    """
    atlas_coords = probe_to_atlas(electrode_xy, tip_atlas, pitch_deg=pitch_deg, yaw_deg=yaw_deg)
